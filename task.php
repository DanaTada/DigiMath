...
<head>
    ...
    <style>
        /* Bloks ar uzdevumu izvēli — DigiMath tēmā */
        .task-selector {
            background: var(--card);
        ...
        .task-selector select {
            ...
            background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24' fill='none' stroke='%23FFD93D' stroke-width='3'><path d='M6 9l6 6 6-6'/></svg>");
            background-repeat: no-repeat;
            background-position: right 16px center;
            transition: border-color .2s;
        }
        .task-selector select:focus { border-color: var(--yellow); }
        .task-selector select option { background: #1A2A52; color: var(--white); }
        .task-selector select option[disabled] { color: var(--yellow); font-weight: 800; }

        .fade-message { animation: fadeOut 3s ease forwards; }
        @keyframes fadeOut {
            0% { opacity: 1; }
            70% { opacity: 1; }
        ...
        <div class="task-page-inner">
            ...
            <div class="task-selector">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <?php if($allCompleted): ?>
                        <span style="background: rgba(31,169,138,.18); color: #4FD1B0; border: 1px solid rgba(31,169,138,.4); padding: 5px 12px; border-radius: 999px; font-size: 12px; font-weight: 700;">Visi pabeigti!</span>
                    <?php endif; ?>
                </div>
                <form method="post">
                    <select name="task_id" required>
                        ...
                        ?>
                                <option disabled>--- <?= $currentGrade ?>. klase ---</option>
                        <?php 
                            endif;
                    ...
                    <button type="submit" name="darbiba" value="izveleties_uzdevumu" class="btn-primary" style="width: 100%; margin-top: 14px;">
